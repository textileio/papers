...
\begin{definition}
  (ReadStore). Stores in Threads provide flexible APIs for persisting and accessing state. The are defined by a Reducer function for handling incoming Actions, and a set of query Resolver functions for handling queries.
\end{definition}
